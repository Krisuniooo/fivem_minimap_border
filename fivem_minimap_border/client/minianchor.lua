--[[
    Link to author's github: https://github.com/glitchdetector/fivem-minimap-anchor
    Thank you for creating this repository, without your work this script would never have been created :)
]]
